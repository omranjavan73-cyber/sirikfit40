            ...
            <div className="p-4 overflow-y-auto space-y-2 flex-1 max-h-[60vh]">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                {modalFilteredCategories.map((cat) => {
                  ...
                  const hasCustomImage = cat.iconUrl && cat.iconUrl.startsWith('http');
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div
                          className="w-10 h-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-800 shrink-0 shadow-2xs overflow-hidden"
                        >
                          {hasCustomImage ? (
                            <img
                              src={cat.iconUrl}
                            ...
                            renderCategoryIcon(theme.iconName, 'w-5 h-5 text-slate-800')
                          )}
                        </div>
