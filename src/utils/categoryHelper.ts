...
export const DEFAULT_CATEGORY_IMAGES: Record<string, string> = {
  all: 'https://images.unsplash.com/photo-1517838277536-f5f99be501cd?w=400&auto=format&fit=crop&q=80',
  protein: 'https://images.unsplash.com/photo-1579722820308-d74e571900a9?w=400&auto=format&fit=crop&q=80',
  creatine: 'https://images.unsplash.com/photo-1593095948071-474c5cc2989d?w=400&auto=format&fit=crop&q=80',
  vitamin: 'https://images.unsplash.com/photo-1584017911766-d451b3d0e843?w=400&auto=format&fit=crop&q=80',
  omega: 'https://images.unsplash.com/photo-1526947425960-945c6e72858f?w=400&auto=format&fit=crop&q=80',
  pre: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400&auto=format&fit=crop&q=80',
  hot: 'https://images.unsplash.com/photo-1546483875-ad9014c88eba?w=400&auto=format&fit=crop&q=80',
  amino: 'https://images.unsplash.com/photo-1594381898411-846e7d193883?w=400&auto=format&fit=crop&q=80',
  gainer: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=400&auto=format&fit=crop&q=80',
  fatburner: 'https://images.unsplash.com/photo-1512069772995-ec65ed45afd6?w=400&auto=format&fit=crop&q=80'
};

/**
 * Returns a high-res realistic photo URL for any category
 */
export function getCategoryImageUrl(categoryKeyOrLabel: string | undefined | null): string {
  const canonical = getCanonicalCategoryKey(categoryKeyOrLabel);
  return DEFAULT_CATEGORY_IMAGES[canonical] || DEFAULT_CATEGORY_IMAGES.all;
}
...
export const DEFAULT_UNIFIED_CATEGORIES: WarehouseCategory[] = [
  ...
  },
  {
    ...
    englishLabel: 'PROTEIN',
    filterKey: 'protein',
    imageUrl: 'https://images.unsplash.com/photo-1579722820308-d74e571900a9?w=400&auto=format&fit=crop&q=80',
    isPinned: true
  },
  {
    id: 'creatine',
  ...
  },
  {
    ...
    englishLabel: 'BEST SELLERS',
    filterKey: 'hot',
    imageUrl: 'https://images.unsplash.com/photo-1546483875-ad9014c88eba?w=400&auto=format&fit=crop&q=80',
    isPinned: true
  },
  {
    id: 'amino',
    ...
    englishLabel: 'AMINO',
    filterKey: 'amino',
    imageUrl: 'https://images.unsplash.com/photo-1594381898411-846e7d193883?w=400&auto=format&fit=crop&q=80',
    isPinned: false
  },
  {
    id: 'gainer',
