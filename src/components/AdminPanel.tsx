        ...
        <div className="space-y-6 font-['Vazirmatn',sans-serif]">
          ...
          <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-950 text-white rounded-3xl p-6 shadow-md flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border border-slate-700/50">
            ...
            <button
              ...
              onClick={handleSaveCms}
              disabled={isSavingCms}
              className="bg-emerald-500 hover:bg-emerald-400 disabled:opacity-80 text-slate-950 font-extrabold text-xs px-4 py-2.5 rounded-xl transition shadow-md shrink-0 flex items-center justify-center gap-2 cursor-pointer"
            >
              {isSavingCms ? (
                <>
          ...
          <div className="bg-white border border-slate-200/90 rounded-3xl p-6 shadow-xs space-y-6 font-['Vazirmatn',sans-serif]">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200">
              ...
              <button
                type="submit"
                disabled={isSavingCms}
                className="bg-emerald-600 hover:bg-emerald-700 disabled:opacity-80 text-white font-extrabold text-xs px-4 py-2.5 rounded-xl transition shadow-xs flex items-center justify-center gap-2 cursor-pointer shrink-0"
              >
                {isSavingCms ? (
                  <>
                    <RefreshCw className="w-3.5 h-3.5 animate-spin text-white" />
